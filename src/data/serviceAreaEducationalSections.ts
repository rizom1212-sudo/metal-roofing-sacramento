...
export const serviceAreaEducationalSections: Record<string, ServiceAreaEducationalSection> = {
  rocklin: {
    ...
    paragraphs: [
      ...
      'When wear becomes widespread—curling tabs, repeated wind lifts, or ridge failures across multiple sections—homeowners often compare repair against [roof replacement](/roof-replacement) so the next system matches Rocklin’s climate more closely. Ready to hire a full asphalt system? See our [shingle roof replacement in Rocklin](/roof-replacement/rocklin) page for process, materials, and estimate next steps. For localized shingle problems, our guide on [missing shingle repair](/blog/missing-shingle-repair-sacramento) explains when a focused tab replacement is still a sound approach and when matching limits or underlayment condition point to a different scope.',
    ],
  },
  folsom: {
    eyebrow: 'Local Roofing Considerations',
    ...
    paragraphs: [
      ...
      'A free [roof inspection](/roof-inspection) before exterior modifications gives you photos and findings you can share with your association or contractor quotes. If you already see water indoors, start with practical leak guidance in our [Folsom roof leak repair](/blog/roof-leak-repair-folsom-ca) article, then hire [emergency roof repair in Folsom](/emergency-roof-repair/folsom) when water is active so assessment and temporary protection can begin quickly.',
    ],
  },
  'granite-bay': {
    eyebrow: 'Local Roofing Considerations',
    ...
    paragraphs: [
      ...
      'A free [roof inspection](/roof-inspection) is especially useful on larger Granite Bay roofs because it organizes findings by plane, transition, and material condition. That clarity helps you prioritize flashing and underlayment issues first, then decide whether localized [roof repair in Granite Bay](/roof-repair/granite-bay) or a broader system update fits the home’s layout and remaining roof life. If water is actively entering, hire [emergency roof repair in Granite Bay](/emergency-roof-repair/granite-bay) first.',
    ],
  },
  'el-dorado-hills': {
    eyebrow: 'Local Roofing Considerations',
