    ...
    <section className="bg-white py-14 md:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <p className="section-subheading max-w-3xl mb-8">
          Homeowner reviews list a matching city when provided. Project photos show captions only; service and location labels are omitted unless separately verified for that image.
        </p>
        ...
        {cityProjects.length > 0 && (
          <div>
            <h3 className="font-bold text-headline text-base mb-4">Project photos</h3>
