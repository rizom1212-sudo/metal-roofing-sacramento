  ...
  return (
    <>
      ...
      <section className="relative bg-charcoal-dark text-white overflow-hidden">
        <HeroBackground image={ASSETS.commercialRoofing('Screenshot_2026-05-20_at_09.33.13.png')} />
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              <a href="#commercial-quote" className="inline-flex items-center justify-center gap-2 btn-outline py-4 px-8 text-base font-semibold">
      ...
      {/* FINAL CTA */}
      <section id="commercial-quote" className="bg-charcoal-dark py-16">
